...
public class FractureDOTS : MonoBehaviour
{
    public TriggerOptionsDOTS triggerOptions;
    public FractureOptionsDOTS fractureOptions;
    public RefractureOptionsDOTS refractureOptions;
    ...
    {
        if (triggerOptions.triggerType == TriggerTypeDOTS.Collision)
        {
    ...
    {
        if (triggerOptions.triggerType == TriggerTypeDOTS.Trigger)
        {
            // Colliding object tag must be in the set of allowed collision tags if filtering by tag is enabled
    ...
    void Update()
    {
        if (triggerOptions.triggerType == TriggerTypeDOTS.Keyboard)
        {
    ...
    private void ComputeFracture()
    {
        ...
        if (mesh != null)
        {
            ...
            {
                StartCoroutine(FragmenterDOTS.FractureAsync(
                    this.gameObject,
    ...
    {
        var fractureComponent = obj.AddComponent<FractureDOTS>();
