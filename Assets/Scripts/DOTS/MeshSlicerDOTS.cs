...
/// </summary>
public static class MeshSlicerDOTS
{
    /// <summary>
    ...
    public static void Slice(FragmentDataDOTS meshData,
                             Vector3 sliceNormal,
                             Vector3 sliceOrigin,
                             Vector2 textureScale,
                             Vector2 textureOffset,
                             out FragmentDataDOTS topSlice,
                             out FragmentDataDOTS bottomSlice)
    {
        topSlice = new FragmentDataDOTS(meshData.vertexCount, meshData.triangleCount);
        bottomSlice = new FragmentDataDOTS(meshData.vertexCount, meshData.triangleCount);
    ...
    /// <param name="textureScale">Scale factor to apply to UV coordinates</param>
    /// <param name="textureOffset">Offset to apply to UV coordinates</param>
    private static void FillCutFaces(FragmentDataDOTS topSlice,
                                     FragmentDataDOTS bottomSlice,
                                     Vector3 sliceNormal,
                                     Vector2 textureScale,
                                     Vector2 textureOffset)
    {
        ...
        var triangulator = new ConstrainedTriangulatorDOTS(topSlice.CutVertices, topSlice.Constraints, sliceNormal);
    ...
    private static void SplitTriangles(FragmentDataDOTS meshData,
                                       FragmentDataDOTS topSlice,
                                       FragmentDataDOTS bottomSlice,
                                       Vector3 sliceNormal,
                                       Vector3 sliceOrigin,
                                       bool[] side,
                                      ...
                                      bool v3BelowCutPlane)
    {
            ...
            MathUtils.LinePlaneIntersection(v2.position, v3.position, sliceNormal, sliceOrigin, out v23, out s23))
        {
            ...
            if (v3BelowCutPlane)
            {
                ...
                topSlice.Constraints.Add(new EdgeConstraintDOTS(topSlice.CutVertices.Count - 2, topSlice.CutVertices.Count - 1));
                bottomSlice.Constraints.Add(new EdgeConstraintDOTS(bottomSlice.CutVertices.Count - 1, bottomSlice.CutVertices.Count - 2));
            }
            else
            {
                ...
                // When looking at the cut-face, the edges should wind counter-clockwise
                topSlice.Constraints.Add(new EdgeConstraintDOTS(topSlice.CutVertices.Count - 1, topSlice.CutVertices.Count - 2));
                bottomSlice.Constraints.Add(new EdgeConstraintDOTS(bottomSlice.CutVertices.Count - 2, bottomSlice.CutVertices.Count - 1));
            }
        }
    }
}