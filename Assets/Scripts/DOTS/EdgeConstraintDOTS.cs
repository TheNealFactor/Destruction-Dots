...
/// </summary>
public class EdgeConstraintDOTS
{
    /// <summary>
    ...
    /// </summary>
    public EdgeConstraintDOTS(int v1, int v2)
    {
        this.v1 = v1;
        this.v2 = v2;
        this.t1 = -1;
    ...
    /// </summary>
    public EdgeConstraintDOTS(int v1, int v2, int triangle1, int triangle2, int edge1)
    {
        this.v1 = v1;
        this.v2 = v2;
        this.t1 = triangle1;
    ...
    {
        if (obj is EdgeConstraintDOTS)
        {
            var other = (EdgeConstraintDOTS)obj;
    ...
    public static bool operator ==(EdgeConstraintDOTS lhs, EdgeConstraintDOTS rhs)
    {
