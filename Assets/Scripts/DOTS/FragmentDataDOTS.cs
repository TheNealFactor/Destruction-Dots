...
public class FragmentDataDOTS
{
    ...
    /// </summary>
    public List<EdgeConstraintDOTS> Constraints;
    ...
    public FragmentDataDOTS(int vertexCount, int triangleCount)
    {
        ...
        this.Constraints = new List<EdgeConstraintDOTS>();
    ...
    public FragmentDataDOTS(Mesh mesh)
    {
