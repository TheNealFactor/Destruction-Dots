...
public class TriangulatorDOTS
{
    ...
    public TriangulationPointDOTS[] points;
    ...
    public TriangulatorDOTS(List<MeshVertex> inputPoints, Vector3 normal)
    {
        ...
        this.points = new TriangulationPointDOTS[N + 3]; // Extra 3 points used to store super triangle
        this.normal = normal;
        ...
        for (int i = 0; i < N; i++)
        {
            ...
            this.points[i] = new TriangulationPointDOTS(i, coords);
        }
    }
    ...
    protected TriangulationPointDOTS[] SortPointsIntoBins()
    {
        ...
        for (int k = 0; k < N; k++)
        {
            ...
            point.bin = BinSortDOTS.GetBinNumber(i, j, n);
        }

        return BinSortDOTS.Sort<TriangulationPointDOTS>(this.points, N, binCount);
    }
    ...
    protected bool ComputeTriangulation()
    {
        ...
        for (int i = 0; i < N; i++)
        {
            TriangulationPointDOTS point = sortedPoints[i];
    ...
    protected void AddSuperTriangle()
    {
        ...
        this.points[N] = new TriangulationPointDOTS(N, new Vector2(-100f, -100f));
        this.points[N + 1] = new TriangulationPointDOTS(N + 1, new Vector2(0f, 100f));
        this.points[N + 2] = new TriangulationPointDOTS(N + 2, new Vector2(100f, -100f));
    ...
    protected void InsertPointIntoTriangle(TriangulationPointDOTS p, int t, int triangleCount)
    {
        //                         V1
        //                         *
        //                        /|\
    ...
    protected void RestoreDelauneyTriangulation(TriangulationPointDOTS p, int t1, int t2, int t3)
    {
        int t4;
