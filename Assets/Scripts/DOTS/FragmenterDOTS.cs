...
public static class FragmenterDOTS
{
    /// <summary>
                                ...
                                string saveFolderPath = "")
    {
        ...
        FragmentDataDOTS sourceMesh = new FragmentDataDOTS(sourceObject.GetComponent<MeshFilter>().sharedMesh);
        ...
        int i = 0;
        foreach (FragmentDataDOTS meshData in fragments)
        {
                             ...
                             Transform parent)
    {
        ...
        // Slice and dice!
        MeshSlicerDOTS.Slice(sourceMesh,
                         sliceNormal,
                         sliceOrigin,
                         options.textureScale,
                         options.textureOffset,
    ...
    private static void CreateFragment(FragmentDataDOTS fragmentMeshData,
