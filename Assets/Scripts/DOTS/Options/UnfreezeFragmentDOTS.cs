...
public class UnfreezeFragmentDOTS : MonoBehaviour
{
    ...
    private void Unfreeze()
    {
        if (this.unfreezeAll)
        {
            foreach (UnfreezeFragmentDOTS fragment in this.transform.parent.GetComponentsInChildren<UnfreezeFragmentDOTS>())
            {
