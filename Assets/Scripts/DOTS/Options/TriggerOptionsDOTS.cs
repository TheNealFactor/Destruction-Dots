...
[Serializable]
public class TriggerOptionsDOTS
{
    [Tooltip("The type of input that triggers the fracture.")]
    public TriggerTypeDOTS triggerType;
    ...
    public TriggerOptionsDOTS()
    {
        this.triggerType = TriggerTypeDOTS.Collision;
